...
@Component({
  selector: 'app-actividad-1-lvl2',
  standalone: true,
  imports: [],
  templateUrl: './actividad-1-lvl2.component.html',
  styleUrl: './actividad-1-lvl2.component.css'
})
export class Actividad1Lvl2Component {
  ...
  listarAudios(): void {
    this.audiosSubscription = this._getAudiosUseCase.getActividadesPorNivel(2).subscribe((response: Actividad1Model[]) => {
