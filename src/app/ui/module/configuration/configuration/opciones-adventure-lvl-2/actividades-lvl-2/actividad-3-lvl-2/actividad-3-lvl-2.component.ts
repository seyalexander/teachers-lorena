...
@Component({
  selector: 'app-actividad-3-lvl-2',
  standalone: true,
  imports: [],
  templateUrl: './actividad-3-lvl-2.component.html',
  styleUrl: './actividad-3-lvl-2.component.css'
})
export class Actividad3Lvl2Component {
...
isTokenExpired(token: string): boolean {
  ...
  obtenerAudios(): void {
    this.ausdiosSubscribe = this._clase4.audios(2).subscribe((response: audioModel[]) => {
