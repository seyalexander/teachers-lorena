...
@Component({
  selector: 'app-actividad-2-lvl-2',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './actividad-2-lvl-2.component.html',
  styleUrl: './actividad-2-lvl-2.component.css'
})
export class Actividad2Lvl2Component {
  loggedInUser = {
    username: 'Almendra',
