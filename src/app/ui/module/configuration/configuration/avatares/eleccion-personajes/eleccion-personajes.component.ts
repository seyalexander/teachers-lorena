...
@Component({
  selector: 'app-eleccion-personajes',
  standalone: true,
  imports: [],
  templateUrl: './eleccion-personajes.component.html',
  styleUrl: './eleccion-personajes.component.css'
})
export class EleccionPersonajesComponent {
