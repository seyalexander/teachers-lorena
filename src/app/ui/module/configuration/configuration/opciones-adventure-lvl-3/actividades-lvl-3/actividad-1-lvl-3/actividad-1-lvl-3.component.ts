...
@Component({
  selector: 'app-actividad-1-lvl-3',
  standalone: true,
  imports: [],
  templateUrl: './actividad-1-lvl-3.component.html',
  styleUrl: './actividad-1-lvl-3.component.css'
})
export class Actividad1Lvl3Component {
  ...
  listarAudios(): void {
    this.audiosSubscription = this._getAudiosUseCase.getActividadesPorNivel(3).subscribe((response: Actividad1Model[]) => {
