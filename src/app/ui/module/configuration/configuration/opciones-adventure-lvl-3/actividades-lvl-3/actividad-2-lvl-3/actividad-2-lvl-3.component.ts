...
@Component({
  selector: 'app-actividad-2-lvl-3',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './actividad-2-lvl-3.component.html',
  styleUrl: './actividad-2-lvl-3.component.css'
})
export class Actividad2Lvl3Component {
  loggedInUser = {
    username: 'Almendra',
