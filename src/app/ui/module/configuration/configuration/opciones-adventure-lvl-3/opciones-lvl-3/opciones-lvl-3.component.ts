...
@Component({
  selector: 'app-opciones-lvl-3',
  standalone: true,
  imports: [],
  templateUrl: './opciones-lvl-3.component.html',
  styleUrl: './opciones-lvl-3.component.css'
})
export class OpcionesLvl3Component {
  ...
  actividadRespuestaCorrecta(): void {
    this.router.navigateByUrl('/home/respuestaCorrectalvl3');
  }

  actividadDibujo(): void {
    this.router.navigateByUrl('/home/dibujolvl3');
  }

  actividadRelacion(): void {
    this.router.navigateByUrl('/home/relacionlvl3');
  }
}
