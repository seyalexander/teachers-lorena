...
@Component({
  selector: 'app-actividad-3-lvl-1',
  standalone: true,
  imports: [],
  templateUrl: './actividad-3-lvl-1.component.html',
  styleUrl: './actividad-3-lvl-1.component.css'
})
export class Actividad3Lvl1Component {
...
isTokenExpired(token: string): boolean {
  ...
  obtenerAudios(): void {
    this.ausdiosSubscribe = this._clase4.audios(1).subscribe((response: audioModel[]) => {
