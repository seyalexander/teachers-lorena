...
@Component({
  selector: 'app-actividad-2-lvl-1',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './actividad-2-lvl-1.component.html',
  styleUrl: './actividad-2-lvl-1.component.css'
})
export class Actividad2Lvl1Component {
  loggedInUser = {
    username: 'Almendra',
