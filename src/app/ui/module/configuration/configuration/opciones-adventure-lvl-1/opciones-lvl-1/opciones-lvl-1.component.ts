...
@Component({
  selector: 'app-opciones-lvl-1',
  standalone: true,
  imports: [],
  templateUrl: './opciones-lvl-1.component.html',
  styleUrl: './opciones-lvl-1.component.css'
})
export class OpcionesLvl1Component {
  ...
  actividadRespuestaCorrecta(): void {
    this.router.navigateByUrl('/home/respuestaCorrectalvl1');
  }

  actividadDibujo(): void {
    this.router.navigateByUrl('/home/dibujolvl1');
  }

  actividadRelacion(): void {
    this.router.navigateByUrl('/home/relacionlvl1');
  }
