...
@Component({
  selector: 'app-actividad-2-lvl-4',
  standalone: true,
  imports: [CommonModule],
  templateUrl: './actividad-2-lvl-4.component.html',
  styleUrl: './actividad-2-lvl-4.component.css'
})
export class Actividad2Lvl4Component {
  loggedInUser = {
    username: 'Almendra',
