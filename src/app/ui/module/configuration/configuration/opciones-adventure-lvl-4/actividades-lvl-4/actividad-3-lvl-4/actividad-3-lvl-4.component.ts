...
@Component({
  selector: 'app-actividad-3-lvl-4',
  standalone: true,
  imports: [],
  templateUrl: './actividad-3-lvl-4.component.html',
  styleUrl: './actividad-3-lvl-4.component.css'
})
export class Actividad3Lvl4Component {
...
isTokenExpired(token: string): boolean {
  ...
  obtenerAudios(): void {
    this.ausdiosSubscribe = this._clase4.audios(4).subscribe((response: audioModel[]) => {
