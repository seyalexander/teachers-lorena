...
@Component({
  selector: 'app-opciones-lvl-4',
  standalone: true,
  imports: [],
  templateUrl: './opciones-lvl-4.component.html',
  styleUrl: './opciones-lvl-4.component.css'
})
export class OpcionesLvl4Component {
  ...
  actividadRespuestaCorrecta(): void {
    this.router.navigateByUrl('/home/respuestaCorrectalvl4');
  }

  actividadDibujo(): void {
    this.router.navigateByUrl('/home/dibujolvl4');
  }

  actividadRelacion(): void {
    this.router.navigateByUrl('/home/relacionlvl4');
  }
}
